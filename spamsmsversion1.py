...
phone = input(f"Nhập số điện thoại: ")
if phone == "0794268460":
    print(f"Không Nên Làm Như Thế")
    exit()
delay = float(input(f"Nhập Delay Giữa Các Tin Nhắn: "))
print(f"Đang Chạy....")
sleep(3)
print(f"Chạy Ẩn Để Cho Khỏi Bị Văng Máy")
print(f"Đang Bắt Đầu Chạy Spam Sms + Call")
